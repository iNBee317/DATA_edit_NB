...
setwd("/Users/pcnnc/Documents/Opto_data/InProgress/03_36/original")
source("03_36_MoCapFunctions.R")
optoimport("03_36")
...
optoLog=read.table("03_36_optoReplant.txt",header=F,sep="")
x=length(optoLog$V1)
...
write.csv(df,file="03_36_outputnumber.csv", row.names=F)
