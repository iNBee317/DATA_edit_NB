...
setwd("/Users/pcnnc/Documents/Opto_data/InProgress/03_39/original")
source("03_39_MoCapFunctions.R")
optoimport("03_39")
...
optoLog=read.table("03_39_optoReplant.txt",header=F,sep="")
x=length(optoLog$V1)
...
write.csv(df,file="03_39_outputnumber.csv", row.names=F)
