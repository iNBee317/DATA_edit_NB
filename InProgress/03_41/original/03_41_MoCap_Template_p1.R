...
setwd("/Users/pcnnc/Documents/Opto_data/InProgress/03_41/original")
source("03_41_MoCapFunctions.R")
optoimport("03_41")
...
optoLog=read.table("03_41_optoReplant.txt",header=F,sep="")
x=length(optoLog$V1)
...
write.csv(df,file="03_41_outputnumber.csv", row.names=F)
