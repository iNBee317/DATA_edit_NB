...
setwd("/Users/pcnnc/Documents/Opto_data/Scripts")
...
optoLog=read.table("03_35_optoReplant.txt",header=F,sep="")
x=length(optoLog$V1)
...
write.csv(df,file="03_35_outputnumber.csv", row.names=F)
